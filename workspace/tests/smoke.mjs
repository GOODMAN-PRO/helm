...
// ---- 43. bin/guiclick: syntax clean + detectScale exported ----
{
...
// ---- 44. gui_task.mjs: syntax clean + guiStep exported ----
{
...
// ---- 45. MCP: playwright entry present with command; gui.step in registry ----
{
